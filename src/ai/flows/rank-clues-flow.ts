...
- Civiles y el Payaso conocen la "Palabra Civil" secreta.
  - Objetivo del Civil: Dar una pista relacionada con la "Palabra Civil". Buenas pistas de civiles son entendibles por otros Civiles pero NO demasiado obvias para Mr. White. Se valora la sutileza, la inteligencia y la creatividad. Una pista que parezca simple pero tenga una conexión profunda o ingeniosa es excelente.
...
- El Payaso conoce la "Palabra Civil".
  - Objetivo del Payaso: Ser votado como si fuera Mr. White. Si lo votan, el Payaso gana. Una buena pista del Payaso es aquella que lo hace parecer sospechoso, como si no conociera la palabra, o incluso una pista que sea deliberadamente "mala" o extraña para atraer votos.

Criterios de Ranking (Debes aplicar esto rigurosamente):
Proporciona un ranking numérico (1 siendo la mejor pista).
Basa tu ranking en:
1.  Para Civiles: Qué tan bien la pista ayuda a otros Civiles a identificarse entre ellos y la "Palabra Civil" SIN ser demasiado obvia para Mr. White. Considera juegos de palabras, dobles sentidos o conexiones no literales. Ejemplo: para la palabra "Helado", la pista "campanillo" podría ser buena si se explica como un juego de palabras con "campanilla" el hada -> "campanillo" el hado (algo mágico y frío).
...
3.  Para el Payaso: Qué tan bien su pista le ayuda a lograr su objetivo de ser votado. Una pista que lo haga parecer culpable o despistado es buena para el Payaso. No la juzgues con los mismos criterios que un Civil.
4.  Inteligencia general, creatividad y adhesión al objetivo de su rol asignado. Una pista no es inherentemente buena o mala; depende del rol y su estrategia.
...
Analiza cada pista individualmente en el contexto del rol del jugador.
`;
